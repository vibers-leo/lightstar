...
export default function ZodiacFortunePage({ onBack }: ZodiacFortunePageProps) {
  ...
  const handlePayment = () => {
    // TODO: 토스페이 연동
    alert('결제 기능 준비 중입니다. (토스페이 연동 예정)');
  };
...
function PremiumCard({ icon, title, content, isLoading, isPaid, onTap }: PremiumCardProps) {
  if (content) {
    return (
